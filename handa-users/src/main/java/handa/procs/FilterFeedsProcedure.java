...
public class FilterFeedsProcedure
extends StoredProcedure
{
    private static final String RESULT = "RESULT";

    public FilterFeedsProcedure(DataSource dataSource)
    {
        setDataSource(checkNotNull(dataSource));
        setSql("HANDA_NEWSFEED.FILTER_FEEDS");
        ...
        declareParameter(new SqlParameter("P_FEED_TYPE", OracleTypes.VARCHAR));
    ...
    public List<NewsFeed> list(String username, String feedType, int pageNo)
    {
