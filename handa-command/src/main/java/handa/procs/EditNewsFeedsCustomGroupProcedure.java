...
public class EditNewsFeedsCustomGroupProcedure
extends StoredProcedure
{
    ...
    public EditNewsFeedsCustomGroupProcedure(DataSource dataSource)
    {
        this.dataSource = checkNotNull(dataSource);
        setDataSource(checkNotNull(dataSource));
        setSql("HANDA_NEWSFEEDS_DIST.EDIT_CUSTOM_GROUP");
